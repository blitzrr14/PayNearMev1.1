...
namespace PayNearMe.Controllers
{
    public class ForgotPasswordController : Controller
    {
        ...
        public ActionResult fpConfReq(String e, String sc, String cid, String fn)
        {
            ...
            ForgotPasswordModelResponse datos = new ForgotPasswordModelResponse();
            ...
            try
            {
                ...
                datos.userData.email = eDecoded;
                datos.userData.securityCode = scDecoded;

                verifyCode(eDecoded, scDecoded, cidDecoded, fnDecoded);
            }
            catch (Exception ex)
            {
