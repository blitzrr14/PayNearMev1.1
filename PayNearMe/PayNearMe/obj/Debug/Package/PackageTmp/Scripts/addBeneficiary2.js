$(document).ready(function () {
    ...
    $('#continue1').click(function () {
        ...
        else if ($('#sendingAmount').val() < 25) {
            alert("Send Amount Must 25 USD Above");
            return;
        }
    ...
    $('input#sendingAmount').focusout(function () {
        ...
        var urx = '../api/WebService/json/getCharge/';
        ajxloadtoggle();
        $.ajax({
            ...
            error: function (response) {
                ajxloadtoggle();
                alert("There was a problem on your request, please try again! Thank You!" + response);
            }
        });
